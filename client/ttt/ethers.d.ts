declare module 'ethers' {
  ...
  namespace providers {
    ...
    class Provider {
      ...
      getCode(addressOrENSName: string, blockTag: string): Promise<Uint8Array>
      getStorageAt(addressOrENSName: string, position: string, blockTag: string): Promise<Uint8Array>
      sendTransaction(signedTransaction: string): Promise<Uint8Array>
      call(transaction: Transaction): Promise<Uint8Array>
